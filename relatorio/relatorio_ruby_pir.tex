...
\lstinputlisting[caption={Programa nano 01 em
  Ruby}]{codigos/ruby/nano01.rb}
...
\end{terminal}
\lstinputlisting[caption={Programa nano 01 em
  PIR}]{codigos/parrot/nano01.pir}

\subsubsection{Nano 02}
\lstinputlisting[caption={Programa nano 02 em
  Lua}]{codigos/lua/nano02.lua}
\lstinputlisting[caption={Programa nano 02 em
  Ruby}]{codigos/ruby/nano02.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
\end{terminal}
\lstinputlisting[caption={Programa nano 02 em
  PIR}]{codigos/parrot/nano02.pir}

\subsubsection{Nano 03}
\lstinputlisting[caption={Programa nano 03 em
  Lua}]{codigos/lua/nano03.lua}
\lstinputlisting[caption={Programa nano 03 em
  Ruby}]{codigos/ruby/nano03.rb}
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
../parrot/nano03.pir --target=pir nano03.rb
\end{terminal}
\lstinputlisting[caption={Programa nano 03 em
  PIR}]{codigos/parrot/nano03.pir}

\subsubsection{Nano 04}
\lstinputlisting[caption={Programa nano 04 em
  Lua}]{codigos/lua/nano04.lua}
\lstinputlisting[caption={Programa nano 04 em
  Ruby}]{codigos/ruby/nano04.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
\end{terminal}
\lstinputlisting[caption={Programa nano 04 em
  PIR}]{codigos/parrot/nano04.pir}

\subsubsection{Nano 05}
\lstinputlisting[caption={Programa nano 05 em
  Lua}]{codigos/lua/nano05.lua}
\lstinputlisting[caption={Programa nano 05 em
  Ruby}]{codigos/ruby/nano05.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
\end{terminal}
\lstinputlisting[caption={Programa nano 05 em
  PIR}]{codigos/parrot/nano05.pir}


\subsubsection{Nano 06}
\lstinputlisting[caption={Programa nano 06 em
  Lua}]{codigos/lua/nano06.lua}
\lstinputlisting[caption={Programa nano 06 em
  Ruby}]{codigos/ruby/nano06.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
\end{terminal}
\lstinputlisting[caption={Programa nano 06 em
  PIR}]{codigos/parrot/nano06.pir}

\subsubsection{Nano 07}
\lstinputlisting[caption={Programa nano 07 em
  Lua}]{codigos/lua/nano07.lua}
\lstinputlisting[caption={Programa nano 07 em
  Ruby}]{codigos/ruby/nano07.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
\end{terminal}
\lstinputlisting[caption={Programa nano 07 em
  PIR}]{codigos/parrot/nano07.pir}

\subsubsection{Nano 08}
\lstinputlisting[caption={Programa nano 08 em
  Lua}]{codigos/lua/nano08.lua}
\lstinputlisting[caption={Programa nano 08 em
  Ruby}]{codigos/ruby/nano08.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
\end{terminal}
\lstinputlisting[caption={Programa nano 08 em
  PIR}]{codigos/parrot/nano08.pir}

\subsubsection{Nano 09}
\lstinputlisting[caption={Programa nano 09 em
  Lua}]{codigos/lua/nano09.lua}
\lstinputlisting[caption={Programa nano 09 em
  Ruby}]{codigos/ruby/nano09.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
\lstinputlisting[caption={Programa nano 10 em
  Lua}]{codigos/lua/nano10.lua}
\lstinputlisting[caption={Programa nano 10 em
  Ruby}]{codigos/ruby/nano10.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
\end{terminal}
\lstinputlisting[caption={Programa nano 10 em
  PIR}]{codigos/parrot/nano10.pir}

\subsubsection{Nano 11}
\lstinputlisting[caption={Programa nano 11 em
  Lua}]{codigos/lua/nano11.lua}
\lstinputlisting[caption={Programa nano 11 em
  Ruby}]{codigos/ruby/nano11.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
\end{terminal}
\lstinputlisting[caption={Programa nano 11 em
  PIR}]{codigos/parrot/nano11.pir}

\subsubsection{Nano 12}
\lstinputlisting[caption={Programa nano 12 em
  Lua}]{codigos/lua/nano12.lua}
\lstinputlisting[caption={Programa nano 12 em
  Ruby}]{codigos/ruby/nano12.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
\end{terminal}
\lstinputlisting[caption={Programa nano 12 em
  PIR}]{codigos/parrot/nano12.pir}

\subsection{Micro Programas}
\subsubsection{Micro 01}
\lstinputlisting[caption={Programa micro 01 em
  Lua}]{codigos/lua/micro01.lua}
\lstinputlisting[caption={Programa micro 01 em
  Ruby}]{codigos/ruby/micro01.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
\end{terminal}
\lstinputlisting[caption={Programa micro 01 em
  PIR}]{codigos/parrot/micro01.pir}


\subsubsection{Micro 02}
\lstinputlisting[caption={Programa micro 02 em
  Lua}]{codigos/lua/micro02.lua}
\lstinputlisting[caption={Programa micro 02 em
  Ruby}]{codigos/ruby/micro02.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
\end{terminal}
\lstinputlisting[caption={Programa micro 02 em
  PIR}]{codigos/parrot/micro02.pir}

\subsubsection{Micro 03}
\lstinputlisting[caption={Programa micro 03 em
  Lua}]{codigos/lua/micro03.lua}
\lstinputlisting[caption={Programa micro 03 em
  Ruby}]{codigos/ruby/micro03.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
\end{terminal}
\lstinputlisting[caption={Programa micro 03 em
  PIR}]{codigos/parrot/micro03.pir}

\subsubsection{Micro 04}
\lstinputlisting[caption={Programa micro 04 em
  Lua}]{codigos/lua/micro04.lua}
\lstinputlisting[caption={Programa micro 04 em
  Ruby}]{codigos/ruby/micro04.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
\end{terminal}
\lstinputlisting[caption={Programa micro 04 em
  PIR}]{codigos/parrot/micro04.pir}

\subsubsection{Micro 05}
\lstinputlisting[caption={Programa micro 05 em
  Lua}]{codigos/lua/micro05.lua}
\lstinputlisting[caption={Programa micro 05 em
  Ruby}]{codigos/ruby/micro05.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
\end{terminal}
\lstinputlisting[caption={Programa micro 05 em
  PIR}]{codigos/parrot/micro05.pir}

\subsubsection{Micro 06}
\lstinputlisting[caption={Programa micro 06 em
  Lua}]{codigos/lua/micro06.lua}
\lstinputlisting[caption={Programa micro 06 em
  Ruby}]{codigos/ruby/micro06.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
linguagem Ruby.
\lstinputlisting[caption={Programa micro 06 em
  PIR}]{codigos/parrot/micro06.pir}

\subsubsection{Micro 07}
\lstinputlisting[caption={Programa micro 07 em
  Lua}]{codigos/lua/micro07.lua}
\lstinputlisting[caption={Programa micro 07 em
  Ruby}]{codigos/ruby/micro07.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
\end{terminal}
\lstinputlisting[caption={Programa micro 07 em
  PIR}]{codigos/parrot/micro07.pir}

\subsubsection{Micro 08}
\lstinputlisting[caption={Programa micro 08 em
  Lua}]{codigos/lua/micro08.lua}
\lstinputlisting[caption={Programa micro 08 em
  Ruby}]{codigos/ruby/micro08.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
\end{terminal}
\lstinputlisting[caption={Programa micro 08 em
  PIR}]{codigos/parrot/micro08.pir}

\subsubsection{Micro 09}
\lstinputlisting[caption={Programa micro 09 em
  Lua}]{codigos/lua/micro09.lua}
\lstinputlisting[caption={Programa micro 09 em
  Ruby}]{codigos/ruby/micro09.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
\lstinputlisting[caption={Programa micro 10 em
  Lua}]{codigos/lua/micro10.lua}
\lstinputlisting[caption={Programa micro 10 em
  Ruby}]{codigos/ruby/micro10.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
\end{terminal}
\lstinputlisting[caption={Programa micro 10 em
  PIR}]{codigos/parrot/micro10.pir}

\subsubsection{Micro 11}
\lstinputlisting[caption={Programa micro 11 em
  Lua}]{codigos/lua/micro11.lua}
\lstinputlisting[caption={Programa micro 11 em
  Ruby}]{codigos/ruby/micro11.rb}
Compilação do Código Ruby:
\begin{terminal}
\$ parrot /Users/oliveira/cardinal/cardinal/cardinal.pbc -o
...
\end{terminal}
\lstinputlisting[caption={Programa micro 11 em
  PIR}]{codigos/parrot/micro11.pir}

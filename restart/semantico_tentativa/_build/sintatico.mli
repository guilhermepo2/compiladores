...
val chunk: (Lexing.lexbuf -> token) -> Lexing.lexbuf -> (Sast.expressao Ast.programa)
...
module Incremental : sig
  ...
  val chunk: Lexing.position -> (Sast.expressao Ast.programa) MenhirInterpreter.checkpoint
